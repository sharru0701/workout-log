...
- **아이콘**: 웹 UI는 Material Symbols Outlined (`<span className="material-symbols-outlined">name</span>`)만. custom SVG UI 아이콘 금지. `apps/tui`의 터미널 글리프는 독립 클라이언트 규칙을 따른다.
