...
export default function WorkoutLogLoading() {
  return (
    <div style={{ padding: "var(--space-md)", display: "flex", flexDirection: "column", gap: "var(--space-md)" }}>
      ...
      <div className="card" style={{ padding: "var(--space-md)" }}>
        {/* 플랜 드롭다운 */}
        <div style={{ ...skeletonStyle, height: 44, width: "100%", marginBottom: "var(--space-md)", borderRadius: 8 }} />
        {/* 날짜 입력 */}
        <div style={{ ...skeletonStyle, height: 36, width: "60%", marginBottom: "var(--space-md)", borderRadius: 8 }} />
        {/* AccordionSection (접힌 상태) */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "var(--space-lg)", padding: "var(--space-sm) 0" }}>
          <div>
            <div style={{ ...skeletonStyle, height: 14, width: 100, marginBottom: 8 }} />
            <div style={{ ...skeletonStyle, height: 11, width: 140, borderRadius: 4 }} />
          </div>
          <div style={{ ...skeletonStyle, height: 20, width: 20, borderRadius: 4 }} />
        </div>
        {/* 빠른 시작 버튼 4개 */}
        <div style={{ ...skeletonStyle, height: 13, width: "25%", marginBottom: "var(--space-sm)", borderRadius: 4 }} />
        <div style={{ display: "flex", gap: "var(--space-sm)", flexWrap: "wrap" }}>
          <div style={{ ...skeletonStyle, height: 44, flex: "1 1 45%", borderRadius: 8 }} />
          <div style={{ ...skeletonStyle, height: 44, flex: "1 1 45%", borderRadius: 8 }} />
          <div style={{ ...skeletonStyle, height: 44, flex: "1 1 45%", borderRadius: 8 }} />
          <div style={{ ...skeletonStyle, height: 44, flex: "1 1 45%", borderRadius: 8 }} />
        </div>
      ...
      <div className="card" style={{ padding: "var(--space-md)" }}>
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} style={{ display: "flex", gap: "var(--space-sm)", alignItems: "center", paddingBlock: 10, borderBottom: i < 3 ? "1px solid var(--color-border)" : "none" }}>
