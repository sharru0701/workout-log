      ...
      <div style={{ display: "grid", gap: "var(--v2-s-5)", paddingBottom: "var(--v2-s-8)" }}>
        <header style={{ display: "grid", gap: "var(--v2-s-4)", paddingTop: "var(--v2-s-2)" }}>
          <div style={{ display: "grid", gap: 8 }}>
            <div style={{ ...skeletonStyle, height: 12, width: "28%", borderRadius: 4 }} />
            <div style={{ ...skeletonStyle, height: 36, width: "42%", borderRadius: 6 }} />
            <div style={{ ...skeletonStyle, height: 18, width: "78%", borderRadius: 4 }} />
          </div>
