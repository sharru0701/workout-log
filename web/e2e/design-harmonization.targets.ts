...
export const designHarmonizationTargets: DesignHarmonizationTarget[] = [
  ...
  { id: "offline", title: "오프라인", path: "/offline" },
  ...
  { id: "calendar-manage", title: "캘린더 관리", path: "/calendar/manage" },
  ...
  { id: "workout-today-log", title: "오늘 운동 로그", path: "/workout/today/log" },
  { id: "workout-today-overrides", title: "오늘 운동 오버라이드", path: "/workout/today/overrides" },
  { id: "workout-record", title: "운동 기록", path: "/workout-record" },
  { id: "workout-record-add", title: "운동 기록 추가", path: "/workout-record/add-exercise" },
  { id: "workout-record-catalog", title: "운동 기록 카탈로그", path: "/workout-record/exercise-catalog" },
  ...
  { id: "stats", title: "통계 홈", path: "/stats" },
  { id: "stats-dashboard", title: "통계 대시보드", path: "/stats/dashboard" },
  { id: "stats-1rm", title: "1RM 통계", path: "/stats-1rm" },
  { id: "stats-filters", title: "통계 필터", path: "/stats/filters" },
  { id: "stats-filters-plan-scope", title: "통계 필터 플랜 범위", path: "/stats/filters/select/plan-scope" },
  { id: "stats-filters-bucket", title: "통계 필터 집계 단위", path: "/stats/filters/select/bucket" },
  { id: "stats-filters-exercise", title: "통계 필터 운동", path: "/stats/filters/select/exercise" },
  { id: "stats-filters-metrics", title: "통계 필터 지표", path: "/stats/filters/select/metrics" },
  { id: "stats-filters-days", title: "통계 필터 기본 일수", path: "/stats/filters/picker/days" },
  { id: "stats-filters-from", title: "통계 필터 시작일", path: "/stats/filters/picker/from" },
  { id: "stats-filters-to", title: "통계 필터 종료일", path: "/stats/filters/picker/to" },
