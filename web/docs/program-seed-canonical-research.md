...
## 최종 채택 프로그램
1. Tactical Barbell Operator (base)
2. Starting Strength LP
3. StrongLifts 5x5
4. Texas Method
5. GZCLP (base T1/T2/T3)
6. Greyskull LP (base A/B)

## 선정 이유 요약
- 단순 로직 검증용 LOGIC 템플릿: Tactical Barbell Operator
...
|---|---|---|---|
| Tactical Barbell Operator | 6주 파형(70/80/90/75/85/95), submax TM 기반 반복, 3일 빈도 high-frequency base | https://www.boostcamp.app/coaches/tactical-barbell/tactical-barbell-operator | https://www.liftosaur.com/programs/strength/tactical-barbell-operator |
...
- 보조운동 대규모 템플릿
- 책/유료 자료에만 있는 상세 변형
- `%TM` 기반 5/3/1 계열(이번 정리 범위에서 legacy 531/candito-linear 제거)
- 프로그램 엔진 신규 kind 추가
