...
## 3) 자주 막히는 포인트
- `5432` 충돌 시: `WEB_PORT=3001 POSTGRES_PORT=5433 pnpm docker:dev:up`
- 컨테이너 재시작 후 이상할 때: `pnpm docker:dev:down` 후 `pnpm docker:dev:up`
- DB 데이터까지 초기화: `pnpm docker:dev:down:volumes`
